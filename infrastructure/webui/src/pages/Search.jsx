...
import { Search as SearchIcon, FileText, Loader2, Sparkles, RefreshCw, MessageSquare } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-slate-400">
          Durchsuche deine Dokumente oder chatte mit dem AI-Assistenten
        </p>
      </div>
      ...
      <div className="flex justify-center mb-8">
        <div className="bg-slate-900/50 p-1 rounded-xl border border-white/10 flex gap-1">
          <button
            ...
            className={`px-6 py-2 rounded-lg text-sm font-medium transition-all flex items-center gap-2 ${mode === 'search'
          ...
          <button
            ...
            className={`px-6 py-2 rounded-lg text-sm font-medium transition-all flex items-center gap-2 ${mode === 'chat'
