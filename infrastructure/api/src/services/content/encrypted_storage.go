...
func (e *EncryptedStorageService) ListEncrypted(relPath string) ([]storage.StorageEntry, error) {
	...
	var items []storage.StorageEntry
...
func (e *EncryptedStorageService) GetEncryptionService() *security.EncryptionService {
	return e.encryption
}
